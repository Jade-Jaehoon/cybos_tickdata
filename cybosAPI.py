...
import sys
sys.path.append("C:/Users/Hoon/PycharmProjects/tickdata/")
...
class CpStockChart:
    ...
    # 차트 요청
    @check_PLUS_status
    def RequestT(self, code, dwm, tick_range, count, caller: 'MainWindow', from_date=0):
        """
        :param code: 종목 코드
        :param dwm:  틱봉
        :param tick_range: 틱단위
        ...
        self.objStockChart.SetInputValue(5, [0, 1, 5, 8,10,11])  # 요청항목 - 날짜, 시간,,종가,거래량 ,누적체결매도 ,누적체결매수
        self.objStockChart.SetInputValue(6, dwm)  # '차트 주기 - 분/틱
        self.objStockChart.SetInputValue(7, tick_range)  # 분틱차트 주기
        self.objStockChart.SetInputValue(9, ord('1'))  # 수정주가 사용

        rq_column = ('date', 'time', 'close', 'volume', '누적체결매도', '누적체결매수')
        rcv_data = {}
